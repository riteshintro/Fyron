...
[![ci](https://github.com/riteshintro/Fyron/actions/workflows/ci.yml/badge.svg)](https://github.com/riteshintro/Fyron/actions/workflows/ci.yml)
[![npm @fyron/core](https://img.shields.io/npm/v/@fyron/core?label=%40fyron%2Fcore)](https://www.npmjs.com/package/@fyron/core)
...
[![license](https://img.shields.io/npm/l/@fyron/core)](LICENSE)
...
```
packages/
  core/               framework runtime (@fyron/core)
...
```ts
import { Route, RequireAuth, type Request } from '@fyron/core';
...
```ts
import { Container, ServiceProvider } from '@fyron/core';
...
```ts
import { z } from 'zod';
import { Route, validate, FormRequest, type Request } from '@fyron/core';
...
```ts
import { Route, RequireAuth, Auth, type Request } from '@fyron/core';
...
```ts
import { Mailable, Mail } from '@fyron/core';
...
import { Schedule } from '@fyron/core';
...
```ts
import { Route, Upload, type Request } from '@fyron/core';
